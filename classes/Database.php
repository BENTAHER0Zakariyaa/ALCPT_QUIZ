...
class Database
{
     ...
     */
    function __construct($database_name, $username = 'root', $password = '', $host = 'localhost', $mock = null)
    {
        self::$instance = $this;
     ...
     * @throws DatabaseException
     */
    final public static function instance($database_name = null, $username = "root", $password = "", $host = 'localhost', $mock = null)
    {
    ...
    // Select or Read data
    public function selectWithJoiners($query)
    {
        $link = self::instance("im_streaming_now");
        $result = $link->query($query) or die($this->link->error . __LINE__);
